...
interface ISwapRouter {
    ...
    function atomicSwap(UniswapLib.SwapInput calldata _input1, UniswapLib.SwapInput calldata _input2) external;
    function executeSwap(UniswapLib.SwapInput calldata _input) external;
